 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.put('/:customerId/debt-work/:recordId', (0, role_middleware_1.roleMiddleware)(['ADMIN', 'ANALYST', 'MANAGER']), debtWorkController.updateDebtWorkRecord);
/**
 * @openapi
 * /customers/{customerId}/debt-work/{recordId}:
 *   delete:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.delete('/:customerId/debt-work/:recordId', (0, role_middleware_1.roleMiddleware)(['ADMIN', 'ANALYST', 'MANAGER']), debtWorkController.deleteDebtWorkRecord);
/**
 * @openapi
 * /customers/{id}/full:
 *   get:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.get('/:id/full', (0, role_middleware_1.roleMiddleware)(['ADMIN', 'ANALYST', 'MANAGER']), customerController.getCustomerFull);
/**
 * @openapi
 * /customers/{id}:
 *   get:
