...
const role_middleware_1 = require("../middlewares/role.middleware"); // Убедитесь, что этот файл существует и экспортирует roleMiddleware
const upload_middleware_1 = require("../middlewares/upload.middleware"); // Наш middleware для multer
...
const dataUploadController = new data_upload_controller_1.DataUploadController();
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/invoices', // Путь относительно префикса /api/v1/data-uploads
(0, role_middleware_1.roleMiddleware)(['ADMIN', 'ANALYST']), // Middleware проверки ролей!
upload_middleware_1.uploadSingleFile, // Middleware от multer для обработки поля 'file'
dataUploadController.uploadInvoices);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/1c-invoices', // Путь для загрузки файлов формата 1C
(0, role_middleware_1.roleMiddleware)(['ADMIN', 'ANALYST']), upload_middleware_1.uploadSingleFile, // Middleware от multer для обработки поля 'file'
dataUploadController.upload1cInvoices);
...
//# sourceMappingURL=data-upload.routes.js.map